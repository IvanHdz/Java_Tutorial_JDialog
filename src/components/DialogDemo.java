...
public class DialogDemo extends JPanel {
    ...
    private JPanel createSimpleDialogBox() {
        ...
        showItButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //ok dialog
                if (command.equals(defaultMessageCommand)) {
                    JOptionPane.showMessageDialog(frame,
                            "Eggs aren't supposed to be green.");

                    //yes/no dialog
                } else if (command.equals(yesNoCommand)) {
                ...
                } else if (command.equals(yeahNahCommand)) {
                ...
                } else if (command.equals(yncCommand)) {
    ...
    private JPanel createPane(String description,
        ...
        JLabel etiqueta = new JLabel(description);
    ...
    private JPanel createIconDialogBox() {
        ...
        showItButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //no icon
                if (command.equals(plainCommand)) {
                    JOptionPane.showMessageDialog(frame,
                            "Eggs aren't supposed to be green.",
                            "A plain message",
                    ...
                    //question icon
                } else if (command.equals(questionCommand)) {
                    JOptionPane.showMessageDialog(frame,
                            ...
                            JOptionPane.QUESTION_MESSAGE);
                    //error icon
                } else if (command.equals(errorCommand)) {
                    JOptionPane.showMessageDialog(frame,
                            "Eggs aren't supposed to be green.",
                            "Inane error",
                            JOptionPane.ERROR_MESSAGE);
                    //warning icon
                } else if (command.equals(warningCommand)) {
                    JOptionPane.showMessageDialog(frame,
                            "Eggs aren't supposed to be green.",
                            "Inane warning",
                            JOptionPane.WARNING_MESSAGE);
                    //custom icon
                } else if (command.equals(customCommand)) {
                    JOptionPane.showMessageDialog(frame,
                            "Eggs aren't supposed to be green.",
                            "Inane custom dialog",
                            JOptionPane.INFORMATION_MESSAGE,
    ...
    private JPanel createFeatureDialogBox() {
        ...
        showItButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //pick one of many
                if (command.equals(pickOneCommand)) {
                    ...
                    //text input
                } else if (command.equals(textEnteredCommand)) {
                    String s = (String) JOptionPane.showInputDialog(
                            frame,
                            "Complete the sentence:\n"
                            + "\"Green eggs and...\"",
                ...
                } else if (command.equals(nonAutoCommand)) {
                ...
                } else if (command.equals(customOptionCommand)) {
                    ...
                    //non-modal dialog
                } else if (command.equals(nonModalCommand)) {
                    //Create the dialog.
                    final JDialog dialog = new JDialog(frame,
                            "A Non-Modal Dialog");
